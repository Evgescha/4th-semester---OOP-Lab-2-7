...
public class Rectangle {
    ...
    //для проверки
    public static void inConss(String str) {
    	try {
    ...
    public double getArea() {
    	try {
    	double res = Math.abs((x2-x1))*Math.abs((y2-y1));
        return res;}
    	catch(Exception ex) {
    		System.out.println("FATAL EROR");
    		return 1/0;
    	}
    }
	...
	public static void main(String[] args) {
		System.out.println("ввод для преобразования строки в число");
		Rectangle.inConss("2вы"); 
		Rectangle rec1 = new Rectangle();
		Rectangle rec2 = new Rectangle(999999999,-999999999);
